...
const Login = () => {
    ...
    <div className="w-full">
        <div className="text-center">
            ...
            <p className="mt-2 text-[#DF5EA2]">Sign in below to access your account</p>
        </div>
        <div className="mt-5">
            <form onSubmit={handleLoginSubmit} >
                <div className="relative mt-6">
                    <input type="email" name="email"  placeholder="Email Address" className="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" autocomplete="NA" />
                ...
                <div className="relative mt-6">
                    <input type="password" name="password"  placeholder="Password" className="peer peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" />
                ...
                <div className="my-6">
                    <button type="submit" className="w-full rounded-md bg-[#DF5EA2] px-3 py-4 text-white ">Sign in</button>
                </div>
               <Link to='/register'>
